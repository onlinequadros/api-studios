...
export class PaymentGetNetService {
  ...
  // FUNÇÃO PARA REALIZAR O PAGAMENTO EM CARTÃO DE CRÉDITO COMO TESTE SANDBOX
  ...
  // FUNÇÃO PARA REALIZAR O PAGAMENTO EM CARTÃO DE CRÉDITO EM HOMOLOGAÇÃO
  async paymentHomologCreditCardGetNet(
  ...
  // FUNÇÃO PARA GERAR O QRCODE PARA FAZER O PAGAMENTO EM PIX EM SANDBOX
